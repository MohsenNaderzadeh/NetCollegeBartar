 ...
 */
public class FullDepartemantsAsyncTask extends AsyncTask<Void,Void,Void> {
    private Context context;
    private ArrayList<Departemants_full_DataModel> DepartemantsList;
    private SqliteManager sqliteManager;


    public FullDepartemantsAsyncTask(Context context, ArrayList<Departemants_full_DataModel> DepartemantsList, SqliteManager sqliteManager)
    {
    ...
    protected Void doInBackground(Void... params) {
        ...
        for (int i = 0; i <DepartemantsList.size() ; i++) {
            Departemants_full_DataModel DepartemantsListDataModel=DepartemantsList.get(i);
