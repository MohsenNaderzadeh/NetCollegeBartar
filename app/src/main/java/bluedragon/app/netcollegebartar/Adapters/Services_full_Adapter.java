 ...
 */
public class Services_full_Adapter extends RecyclerView.Adapter<Services_full_Adapter.Services_View_Holder>
{

    private Context context;
    private List<Services_full_DataModel> Services_List;

    public Services_full_Adapter(Context context, List<Services_full_DataModel> Services_List)
    {
    ...
    public void onBindViewHolder(@NonNull final Services_View_Holder holder, int position) {
        ...
        Services_full_DataModel services=Services_List.get(position);
