 ...
 */
public class Teachers_full_recyclerview_Adapter  extends  RecyclerView.Adapter<Teachers_full_recyclerview_Adapter.TeachersfullRecyclerviewviewHolder> {

private Context context;
private List<Teachers_full_DataModel> Teacher_List;



    public Teachers_full_recyclerview_Adapter(Context context, List<Teachers_full_DataModel> Teachers_list)
    {
    ...
    @NonNull
    @Override
    public TeachersfullRecyclerviewviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.teachers_recyclerview_adapter,null);
        return new TeachersfullRecyclerviewviewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final TeachersfullRecyclerviewviewHolder holder, int position) {

        Teachers_full_DataModel Teachers=Teacher_List.get(position);
    ...
    public class TeachersfullRecyclerviewviewHolder extends RecyclerView.ViewHolder
{
    ...
    public TeachersfullRecyclerviewviewHolder(View itemView) {
        super(itemView);
